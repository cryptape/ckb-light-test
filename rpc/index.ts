...
// import {Hexadecimal, HexNumber, HexString} from "@ckb-lumos/base/lib/primitive";
// import {fetchTransactionUntilFetched} from "../service/txService";
// import {LightClientRPC} from "@ckb-lumos/light-client";
// import {GetCellsSearchKey, Order} from "@ckb-lumos/ckb-indexer/lib/type";
...
//
//     const infos: Cell[] = [];
//     let request1 = [getCellsReq.search_key, getCellsReq.order, getCellsReq.limit];
